        ...
        <section class="text-gray-600 body-font">
            <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
                    <img class="object-cover object-center rounded" alt="hero" src="assects/images/schoolImages/afaq-image2.jpg">
                </div> 
                <div class="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
                    <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-blue-600">Contactez-nous
                        <br class="hidden lg:inline-block">
                    </h1>
                    <p class="text-sm md:text-base text-justify mb-8 leading-relaxed"><?php echo $row['one']; ?></p>
                    <div class="flex justify-center">
                        <button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded text-lg" onclick="callschool()">téléphone</button>
        ...
        <section class="text-gray-600 body-font relative">
            <div class="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap pt-0">
                <div class="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
                    <iframe width="100%" height="100%" class="absolute inset-0" frameborder="0" title="map" marginheight="0" marginwidth="0" scrolling="no" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3373.866808229214!2d-8.531044725209401!3d32.26166567388315!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xdaee3278cec44a5%3A0x6953ddcbfeb0cb2a!2z2YXYpNiz2LPYqSDYo9mB2KfZgiDZhNmE2KrYudmE2YrZhSDYp9mE2K7YtdmI2LXZig!5e0!3m2!1sfr!2sma!4v1735118875957!5m2!1sfr!2sma"></iframe>
                    ...
                    <div class="pr-2 bg-white relative flex flex-wrap py-6 rounded shadow-md">
                        <div class="lg:w-1/2 px-6">
                            ...
                            <p class="text-sm md:text-base text-justify mt-1 cursor-pointer" onclick="locationmap()"> Maroc youssoufia agendize </p>
                        </div>
                        <div class="lg:w-1/2 px-6 mt-4 lg:mt-0">
                            <h2 class="title-font font-semibold text-gray-900 tracking-widest text-xs">EMAIL</h2>
                            <a class="text-sm md:text-base text-justify text-indigo-500 leading-relaxed cursor-pointer" onclick="mailschool()"> Afaqalmaarifa@yahoo.fr</a>
                            <h2 class="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">PHONE</h2>
                            <p class="text-sm md:text-base text-justify leading-relaxed cursor-pointer" onclick="callschool()"> +212 5246-45484</p>
                        </div>
                    </div>
                </div>
                <div class="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
                    <h2 class="text-gray-900 text-lg mb-1 font-medium title-font">contact</h2>
                    <p class="text-sm md:text-base leading-relaxed mb-5 text-gray-600">Vos précieux commentaires sur notre école sont attendus avec impatience et appréciés ici.</p>
                    ...
                    <p class="text-xs text-gray-500 mt-3 feedbacktext">Vos contributions seront transmises à l'administration de l'école.</p>
                </div>
            </div>
        </section>
